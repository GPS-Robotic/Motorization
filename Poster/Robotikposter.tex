...
Die Zielsetzung unseres Projektes besteht darin, ein Modellbauto über ein on-board GPS-Modul zu steuern. Dabei liest ein Raspberry-Pi GPS-Daten ein und kommuniziert mit Lenkung und Antrieb, um eine Zielkoordinate anzufahren.\\
In einem weiteren Schritt bringen wir Sensoren an das Auto an, die das Erkennen von Hindernissen ermöglichen. Ein Algorithmus soll daraufhin die Route derart anpassen, dass das Ziel dennoch erreicht wird.
