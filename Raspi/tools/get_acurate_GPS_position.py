# This script can be used to get more acurate (averaged) gps-position, if vehicle stands still (e.g. to find target coordinates)
# It will continously print 30 GPS-values and average them.
