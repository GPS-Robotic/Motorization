...
<div style="text-align:center"> <img src ="{{ site.baseurl }}/images/documentation/eyes2.jpg" alt="Current appearance of our eyed car." width="60%"> </div>
...
<div style="text-align:center"> <img src ="{{ site.baseurl }}/images/documentation/map.png" alt="Out on the road." width="60%"> </div>
...
<div style="text-align:center"> <img src ="{{ site.baseurl }}/images/documentation/shell.jpg" alt="Second time on the road." width="60%"> </div>
