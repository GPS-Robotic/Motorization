...
#CAUTION: time-delay....
def right90(current_status, speed='slow'):
...
def right45(current_status, speed='slow'):
	accelerate(current_status, ['break',speed,'right'])	#break
	sleep(Sleeping_Time)
	driving(current_status, ['backward',speed,'right'])	#turn right backwards
	sleep(3.3*Sleeping_Time_90[speed])	#wait X-seconds to turn -> ADJUST!
	driving(current_status, ['break', 'slow', 'straight'])

#function for quickly turning 90 degrees right 
#speed=slow, middle, fast (for turning process only)
#CAUTION: time-delay....
def left45(current_status, speed='slow'):
...
def left90(current_status, speed='slow'):
	accelerate(current_status, ['break',speed,'left'])	#break
	sleep(Sleeping_Time)
	driving(current_status, ['backward',speed,'left'])	#turn right backwards
	sleep(5.0*Sleeping_Time_90[speed])	#wait X-seconds to turn -> ADJUST!
...
def left90test(current_status, delay_time, speed='slow'):
	accelerate(current_status, ['break',speed,'left'])	#break
	sleep(Sleeping_Time)
	driving(current_status, ['backward',speed,'left'])	#turn right backwards
